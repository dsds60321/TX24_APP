...
import kr.tx24.fc.service.UserSvc;
...
public class UserCtl {
    ...
    public UserCtl(UserSvc userSvc, SessionSvc sessionSvc) {
    ...
    public @ResponseBody TxResponse<?> updateProfile(@Session SharedMap<String,Object> session, @RequestBody SharedMap<String, Object> param) {
        return TxResponse.ok(userSvc.updateProfile(session, param), "프로필을 수정했습니다.");
    }
}
